...
def main():
    ...
    # please re-run the 3d kps and 3d hand point cloud gen codes
    # finish pre-optimization, 01, 03, 04, 11, 13, 16, 18, 19, 20, 21, 22, 23, 02 06 24 25 26 27 28 29 31 32 33 34 35 36 37
    #  01_gesture, 
    # '04_gesture', '06_gesture', '13_gesture'
    # '21_gesture', '23_gesture', \
    # '24_gesture', '25_gesture', '26_gesture', '27_gesture', '28_gesture', '29_gesture', \
    # '30_gesture', '31_gesture', '32_gesture', '33_gesture', '35_gesture', '34_gesture', '36_gesture', '02_gesture', '37_gesture'
    sub_ls = sorted(['01_kitchen', '04_kitchen'])  #
    # finish '18', '19', '20', '24', '25', '26', '27', '28', '29', '31', '32', '33', '34', '35', '36', '37'
    ...
    for sub in sub_ls:
        ...
        # if not os.path.exists(os.path.join(save_path, 'cut_paper', 'ego', 'mask_2d')):
        ...
        # hand_optimiztion(root_path, save_path, 1)
