...
class H2OHands(object):
    ...
    def load_dataset(self): 
        ...
        for info_segments in tqdm(self.frame_segments): 
            for iid in range(info_segments["start_idx"],info_segments["end_idx"]+1):
                ...
                relative_img_path=os.path.join(info_segments["subject"],info_segments["scene"],"depth320_240","{:06d}.png".format(iid))
