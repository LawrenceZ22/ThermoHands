...
def get_dataset_htt(
    ...
    elif dataset_name=='thermal_rgb':
        pose_dataset = thermal_rgb.H2OHands(dataset_folder=dataset_folder,
                                    split=split,
                                    ntokens_pose=ntokens_pose,
                                    ntokens_action=ntokens_action,
                                    spacing=spacing,
    ...
    elif dataset_name=='thermal_depth':
        pose_dataset = thermal_depth.H2OHands(dataset_folder=dataset_folder,
                                    split=split,
                                    ntokens_pose=ntokens_pose,
                                    ntokens_action=ntokens_action,
                                    spacing=spacing,
                                    ...
                                    split_type=split_type)
        input_res = (320, 240)
    elif dataset_name=='thermal_jet':
        pose_dataset = thermal_jet.H2OHands(dataset_folder=dataset_folder,
                                    split=split,
                                    ntokens_pose=ntokens_pose,
                                    ntokens_action=ntokens_action,
                                    spacing=spacing,
    ...
    elif dataset_name=='thermal_mano':
        pose_dataset = thermal_mano.H2OHands(dataset_folder=dataset_folder,
                            split=split,
                            ntokens_pose=ntokens_pose,
                            ntokens_action=ntokens_action,
                            spacing=spacing,
    ...
    if dataset_name == 'h2ohands_a2j':
        dataset = seqset_a2j.SeqSet(
