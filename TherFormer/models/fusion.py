...
class TemporalNet(torch.nn.Module):
    def __init__(self,  is_single_hand,
        ...
        self.meshregnet_t = ResNet_(resnet_version=18)
    ...
    def forward(self, batch_flatten,  verbose=False):     
        ...
        flatten_images_t = batch_flatten[TransQueries.IMAGE_T].cuda()
        #Loss
        ...
        flatten_in_feature_t, _ = self.meshregnet_t(flatten_images_t)
        flatten_in_feature = flatten_in_feature + flatten_in_feature_t
        #Block P
