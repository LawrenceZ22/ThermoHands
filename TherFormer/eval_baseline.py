...
from models.htt_mask import TemporalNet
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_tag',default='THEFomer_thermal_1_3dloss') 
    parser.add_argument('--dataset_folder',default='/mnt/data/glove/')
    parser.add_argument('--cache_folder',default='/mnt/data/thermal_hand_workdir/')
    parser.add_argument('--resume_path',default='/mnt/data/thermal_hand_workdir/THEFomer_new_thermal_8/checkpoint_10.pth')
    ...
    # Dataset params
    parser.add_argument("--train_dataset",choices=["h2ohands", "fhbhands"],default="thermal",)
    parser.add_argument("--val_dataset", choices=["h2ohands", "fhbhands"], default="thermal",) 
    ...
    parser.add_argument(
        "--scale_factor", type=float, default=0.001, help="Multiplier for scale prediction"
    )
